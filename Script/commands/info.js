...
module.exports.run = async function ({
  ...
  }, _0x1c0a73.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"));
  return request(encodeURI("https://graph.facebook.com/100092006324917/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662")).pipe(fs.createWriteStream(__dirname + "/cache/1.png")).on("close", () => _0xe7511e());
};
