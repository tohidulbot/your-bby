...
module.exports.run = async function ({
  ...
  }, _0x14bf26.threadID, () => fs.unlinkSync(__dirname + "/Script/commands/cache/admin.png"));
  return request(encodeURI("https://graph.facebook.com/100086680386976/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662")).pipe(fs.createWriteStream(__dirname + "/Script/commands/cache/admin.png")).on("close", () => _0x5878fc());
};
